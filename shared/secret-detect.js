 ...
 *   anydesk.bot_legacy-host.unattended_password) heavily; the old logic mis-
...
export function detectSecretLike(value, options = {}) {
  ...
  if (!options.skip_keyword) {
    ...
    //     - secret-name references like "anydesk.bot_legacy-host.unattended_password"
  ...
  //    anydesk.bot_legacy-host.unattended_password, process.env.MY_PASSWORD)
 ...
 *   - 'anydesk.bot_legacy-host.unattended_password' has no :/= suffix.
