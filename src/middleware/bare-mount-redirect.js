...
// the prefix.
//
// Measured on production 2026-08-04: `https://legacy-server.example/ownmind/dashboard` sent the
// browser to `https://legacy-server.example/dashboard/`, an unrelated page. `/ownmind/admin` did the
