...
同一個根因的另一半，但這半救不回來 —— 伺服器重建那條路只有活動記錄可以讀，而活動記錄裡沒有專案名稱。

量到的範圍比想像大：那一週 **Vincent 自己 95 場裡有 76 場是重建的**，Michelle、Phoebe、采瑤、Vin-windows-test 則是**全部**。所以這一欄對四個人全空，對第五個人空掉五分之四。

要補得先決定專案名稱從哪來，列進 backlog 39。
