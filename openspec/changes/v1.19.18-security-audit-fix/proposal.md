...
- 部署到 legacy-server.example 並瀏覽器實測
...
- [ ] 部署後 https://legacy-server.example/ownmind/admin/ 可正常登入
- [ ] 部署後 https://legacy-server.example/ownmind/api/clients/version 回 v1.19.18
- [ ] 三語系版號 1.19.18
