...
- Deploy to legacy-server.example and test in the browser
...
- [ ] After deploy, https://legacy-server.example/ownmind/admin/ logs in normally
- [ ] After deploy, https://legacy-server.example/ownmind/api/clients/version returns v1.19.18
