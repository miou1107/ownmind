...
- [ ] legacy-server.example deploy:
  - [ ] ssh legacy-server.example
  - [ ] cd /srv/ownmind && git pull
...
- [ ] Post-deploy test (IR-020):
  ...
  - [ ] `curl https://legacy-server.example/ownmind/api/clients/version` returns 1.19.18
