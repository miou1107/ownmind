...
- [x] Confirmed the landing page: `https://legacy-server.example/dashboard/` answers 200 with an
...
- [x] Commit `26e7d4e`, tag `v1.26.57`, pushed, deployed to legacy-server.example
...
- [x] Verified on production. Every variant now stays inside the prefix:
      ...
      `https://legacy-server.example/ownmind/dashboard/` with `<title>OwnMind 控制中心</title>`
