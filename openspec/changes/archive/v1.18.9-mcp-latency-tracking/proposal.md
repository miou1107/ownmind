...
- The link URL carries an HMAC signature (to prevent the URL from being hijacked): `https://legacy-server.example/ownmind/feedback/block?event_id=xxx&sig=abc123`
