...
`https://legacy-server.example/ownmind/admin/` (2026-07-29): the card read `0` while the
...
Patch bump to `v1.26.39`. Deploy to legacy-server.example, then confirm in the browser that
