...
- [x] Released and deployed 2026-07-30. `v1.26.45` on `/srv/ownmind`,
      ...
      **Correcting two things I asserted earlier without checking**: this repo has no CI
      ...
      applied here); and `root@legacy-server.example` accepts key-based SSH, so the earlier claim that
...
- [x] Released and deployed 2026-07-31. `v1.26.48` on `/srv/ownmind` (found this
...
- [x] Released and deployed 2026-08-04. `v1.26.56` on `/srv/ownmind`,
...
- [x] Released and deployed 2026-08-04. `v1.26.58` on `/srv/ownmind`,
...
- [x] Released and deployed 2026-08-05. `v1.26.59` on `/srv/ownmind`,
