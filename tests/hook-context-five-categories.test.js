...
describe('issue #94 — the reminder lists every memory category', () => {
  ...
  // v1.30.26 - the shell hook's end-to-end block is gone with that hook. It drove the
  // five-category request through the shell copy; the .js hook is the only wiring now, and
  // the render tests above cover what it does with the response.
});
