...
const BUNDLE = {
  selectors: [
    { id: 412, type: 'team_standard', tags: ['trigger:ci'], keywords: ['company host'], always_check: false, repo_match: 'shared-monorepo' },
  ...
  injectables: [
    { id: 412, title: 'ci ownership', content: 'NEVER edit ci/projects.yml.', keywords: ['company host'], always_check: false, repo_match: 'shared-monorepo', paths: ['ci/**'], owner: 'Colleague' },
  ],
};
