...
tests/memory-secret-guard.test.js            — 93 行（含 v1.19.13 matched_text / bot-server.example regression）
...
tests/memory-secret-guard.test.js                                    — +4 case：S3 400 含 matched_text、S4 bot-server.example 全文 regression
